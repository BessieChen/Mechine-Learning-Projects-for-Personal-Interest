...
if __name__ == "__main__":
    ...
    for ticker in ticker_arr:
        ...
        stock_data, stock_returns, stock_lag, stock_movement = create_shifted_orderbook_more_feature(ticker, start_date=start,
                                                                                        end_date=end,
                                                                                        lag_period=lag,
        ...
        fit_feature_importance_cross_validation(ticker, feature_label_list, forest, stock_feature_df.values, stock_movement.values, splits=3)
